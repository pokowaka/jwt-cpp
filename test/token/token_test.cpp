...
public:
  ...
  void BadHeader(const std::string &jwt) {
    ASSERT_THROW(JWT::Decode(jwt, &none_), TokenFormatError);
  }

  void ValidToken(const std::string &jwt, MessageValidator *validator,
  ...
  void ImproperSignedToken(const std::string &jwt,
                           MessageValidator *validator) {
    ASSERT_THROW(JWT::Decode(jwt, validator), InvalidTokenError);
  }

  void ImproperClaims(const std::string &jwt, ClaimValidator *claims) {
...
TEST_F(TokenTest, bad_format_tokens) {
  ...
  BadHeader("eyJhbGciOiJIUzI1NiIsInR5cCI6IkJBUiJ9."
            ...
            "V9");
  BadHeader("e y J h b G c i O i J I U z I 1 N i I s I n R 5 c C I 6 I k p X V "
            "C J "
            "9."
            "eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydW"
            "V9."
...
TEST_F(TokenTest, token_with_large_wrong_signature) {
  std::string token =
      ...
      "eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydW"
      "V9."
      "TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQTJVA95OrM7E2cBab30RMHrH"
      "DcEf"
      "xj"
      "oYZgeFONFh7HgQ"
      "TJVA95OrM7E2cBab30RMHrHDcEfxjoYZgeFONFh7HgQTJVA95OrM7E2cBab30RMHrH"
